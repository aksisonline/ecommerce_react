...
export default function Home() {
  ...
  const latestDeals = [
    { 
      ...
      image: 'https://th.bing.com/th/id/OIP.tdaQ3-VLGlZNzFmp-gvzMwAAAA?rs=1&pid=ImgDetMain' 
    },
    { 
      id: 2, 
      name: 'Deal 2', 
      description: 'Buy 1 Get 1 Free on selected fashion items!', 
      image: 'https://th.bing.com/th/id/OIP.eRr2i5ljCESwIaVNoT6BOQHaD4?rs=1&pid=ImgDetMain' 
    },
  ];
  ...
  const testimonials = [
    {
      id: 1,
      name: 'John Doe',
      feedback: 'Fantastic service and high-quality products! Highly recommend E-React for online shopping.',
      image: 'https://th.bing.com/th/id/OIP.IGNf7GuQaCqz_RPq5wCkPgHaLH?w=134&h=202&c=7&r=0&o=5&dpr=1.5&pid=1.7',
    },
    {
      id: 2,
      name: 'Jane Smith',
      feedback: 'E-React made my shopping experience so easy and enjoyable. The deals are amazing!',
      image: 'https://th.bing.com/th/id/OIP.pYFUThD3lXgVcPzPJsOSKQHaKi?w=142&h=202&c=7&r=0&o=5&dpr=1.5&pid=1.7',
    },
  ];
      ...
      <section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {testimonials.map((testimonial) => (
            <div key={testimonial.id} className="bg-white rounded-lg shadow-md overflow-hidden p-4 flex items-center">
              <img
